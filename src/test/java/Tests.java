...
public class Tests extends BaseTest {
    String email = "EmailAdresi"; //Gittigidiyor Kayıtlı Mail adresi
    String password = "Parola"; //Gittigidiyor Kayıtlı Şifre
    ...
    public void Login() {
        ...
        Assertions.assertEquals(this.email, loginPage.getEmail(), "Email Giriş Bilgisi Hatalıdır.");
        loginPage.setPassword(this.password);
        Assertions.assertEquals(this.password, loginPage.getPassword(), "Şifre Giriş Bilgisi Hatalıdır");
